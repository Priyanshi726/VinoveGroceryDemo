        ...
        <View>
          <ScrollView>
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../Assets/vegi2.png')}
                style={{width: 170}}
              />
              <View style={{}}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                alert('Wants To Buy Some Cooking Oil & Ghee');
              }}>
              <Image
                source={require('../Assets/drinks2.png')}
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                alert('Bought Some Bakery & Snacks For Your Family');
              }}>
              <Image
                source={require('../Assets/cookies.png')}
                style={{width: 170, height: 143}}
              />
              <View style={{}}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                alert('Lets have some Chilled Coked');
              }}>
              <Image
